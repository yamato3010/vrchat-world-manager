...
function registerIpcHandlers() {
  var _this = this;
  electron.ipcMain.handle("get-worlds", function(_, groupId) {
    return __awaiter(_this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        if (groupId) {
          return [2, prisma.world.findMany({
            where: {
              groups: {
                some: {
                  groupId
        ...
        return [2, prisma.world.findMany({ include: { groups: true } })];
      });
    });
  });
  electron.ipcMain.handle("create-world", function(_, data) {
    return __awaiter(_this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        return [2, prisma.world.create({
          data: {
  ...
  electron.ipcMain.handle("delete-world", function(_, id) {
    return __awaiter(_this, void 0, void 0, function() {
      return __generator(this, function(_a) {
        return [2, prisma.world.delete({ where: { id } })];
      });
    });
  });
  electron.ipcMain.handle("fetch-vrchat-world", function(_, worldId) {
    return __awaiter(_this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3]);
            return [4, axios.get("https://api.vrchat.cloud/api/1/worlds/".concat(worldId), {
              headers: {
