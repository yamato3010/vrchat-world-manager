...
export function WorldDetail({ worldId, onBack }: WorldDetailProps) {
    ...
    if (!world) {
        return <div className="flex items-center justify-center h-full">World not found</div>
    }
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                    ...
                    {world.authorName && (
                        <p className="text-gray-400 mb-4">by {world.authorName}</p>
                    )}
                    ...
                    {world.userMemo && (
                        <div className="mb-6 bg-gray-700 p-4 rounded">
                            <h2 className="text-xl font-semibold mb-2 text-yellow-400">My Memo</h2>
                            <p className="text-gray-200 whitespace-pre-wrap">{world.userMemo}</p>
                        </div>
                    )}

                    <div className="mb-6">
                        <h2 className="text-xl font-semibold mb-4">Assign to Groups</h2>
                        {groups.length === 0 ? (
                            <p className="text-gray-500 italic">No groups created yet. Create a group in the sidebar.</p>
                        ) : (
